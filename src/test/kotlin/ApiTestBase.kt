...
import VideoGame.VGRestApplication
...
@SpringBootTest(classes = [(VGRestApplication::class)],
...
abstract class ApiTestBase {
    ...
    fun clean() {
        ...
        RestAssured.basePath = "/videogamerest/api/videoGames"
         ...
         */
        list.stream().forEach {
            RestAssured.given().pathParam("name", it.name)
                    .delete("/{name}")
                    .then()
                    .statusCode(204)
        }
